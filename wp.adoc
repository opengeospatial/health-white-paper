:Title: Health Spatial Data Infrastructure: Application Areas, Recommendations, and Architecture
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/WP/Health-SDI
|Internal reference number of this OGC(R) document:    19-076
|Category: OGC(R) White Paper
|Editors:   Gupta, AJAY, Bermudez, LUIS, Oldfield, EDDIE, Serich, SCOTT
|===
...
// Moved content of scenario.adoc to 6-intro-app-areas.adoc
//include::scenario.adoc[]

// Moved content of data-requirements.adoc to 7-data-considerations.adoc
