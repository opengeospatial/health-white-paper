...
Healthcare Outcomes Data, Survey Data, Vector, Public Health, "CVS, WPS, WMS, WFS, SLD, WCS, hierarchical and relational schemas"
Hospital Discharge Data, Medical Records Data, Vector, Public Health, CVS
Social Vulnerability Indices, Social Determinants of Health, Vector, "Public Health, Disaster Recovery","CVS, WFS"
