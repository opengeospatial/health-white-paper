...
This white paper has attempted to lay out the case for the development of a Global Health SDI, discussing specific applications where such a solution can be helpful. In the process, the current market requirements as well as the current state of the art are also identified. The next steps in this process is identifying the open data standards that either need to be updated to accommodate and support a Health SDI or the creation of a documented profile for implementation that can guide the implementation and establishment of a Health SDI. This can be done through a concept development study or perhaps be incorporate into TestBed effort going forward. 
