...
Adding to this list, on March 11, 2020, the World Health Organization (WHO) declared the novel strain of Coronavirus, which originated in Wuhan, China in late 2019 and is known officially as COVID-19, as a pandemic cite:[whoCovid19Announcement]. National and international response to this pandemic have included international travel restrictions, the cancelation of nearly all large gatherings of people across the globe including public, entertainment, and sporting events – as well as  religious pilgrimages and Sunday Mass at the Vatican, as well as the quarantine and social isolation of over a billion people across a majority of the world’s countries. Addressing COVID-19 will require concerted effort from government at all levels, the private sector, as well as the public.
